...
class M3 
{
	...
	{
		C c1 = new C();
		System.out.println(1 + ":" + c1);//hashcode
		System.out.println(2 + ":" + C.obj);//null
		Util.sleep(1000);
		c1 = null;
		System.gc();
		Util.sleep(1000);
		System.out.println(3 + ":" + c1);//null
		System.out.println(4 + ":" + C.obj);//hashcode
		C.obj = null;
		Util.sleep(1000);
		System.gc();
		System.out.println(5 + ":" + c1);//null
		System.out.println(6 + ":" + C.obj);//null
